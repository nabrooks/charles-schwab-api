...
namespace NbTrader.Brokers.TDAmeritrade
{
    ...
    /// </summary>
    public class TDAmeritradeWebSocketStreamClient : IDisposable
    {
        ...
        JsonSerializerOptions _options = new JsonSerializerOptions { DefaultIgnoreCondition = System.Text.Json.Serialization.JsonIgnoreCondition.WhenWritingDefault };
        ...
        public TDAmeritradeWebSocketStreamClient(TDAmeritradeClient client)
        {
            _client = client;
        ...
        public async Task Connect()
        {
            try
            {
                ...
                if (_prince == null || _prince.accounts == null)
                    throw new Exception("No user principals or accounts were returned from the TD Ameritrade servers");
        ...
        {
            if (_socket == null)
                throw new Exception("The socket is null, Connect before invoking 'Receive'");
        ...
        private Task Login()
        {
            ...
            if (_prince == null || _prince.streamerInfo == null || _prince.streamerInfo.tokenTimestamp == null)
                throw new Exception("");
