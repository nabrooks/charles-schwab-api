...
namespace NbTrader.Brokers.TDAmeritrade.V2.Shared
{
    public class StringEnumWithDefaultConverter : JsonConverter
    {
        ...
        public override object? ReadJson(JsonReader reader, Type objectType, object? existingValue, JsonSerializer serializer)
        {
            ...
            if (reader.TokenType == JsonToken.String)
            {
                ...
                var val = FromValue(enumType, enumText?? string.Empty);
            ...
            Console.WriteLine("The response value {val} cannot be mapped to the enum type {enumType}.", reader.Value, enumType);
